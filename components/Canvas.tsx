...
const Cursor = ({ visible, weight }: CursorProps) => {
	...
	return (
		<div
			...
			className="fixed pointer-events-none rounded-full border -translate-x-1/2 -translate-y-1/2 border-neutral-900 cursor-none">
			<div className="w-full h-full rounded-full border border-white pointer-events-none" />
		</div>
	);
};
